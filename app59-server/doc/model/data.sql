...
-- task_lecture_board 테이블에 데이터 삽입: 
INSERT INTO task_lecture_board (lec_board_no, lecture_no, lec_title, lec_content, lec_writer, lec_view_count, lec_reg_date, lec_mdf_date, lec_status)
