...
public class FreeBoardUpdateServlet extends HttpServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response)
    ...
    freeBoard.setFreeBoardNo(Integer.parseInt(request.getParameter("no")));
    freeBoard.setFreeTitle(request.getParameter("title"));
    freeBoard.setFreeContent(request.getParameter("content"));
