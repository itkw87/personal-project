...
-- 강의게시판
DROP TABLE IF EXISTS task_lec_board RESTRICT;
...
CREATE TABLE task_member (
                             ...
                             member_photo       VARCHAR(255) NULL     COMMENT '사진' -- 사진
)
    COMMENT '회원';
...
-- 강의게시판
ALTER TABLE task_lec_board
    ADD CONSTRAINT PK_task_lec_board -- 강의게시판 기본키
        PRIMARY KEY (
...
-- 강의게시판
ALTER TABLE task_lec_board
    ADD CONSTRAINT FK_task_participant_TO_task_lec_board -- 참여자 -> 강의게시판
        FOREIGN KEY (
                     lecture_no, -- 강의번호
...
-- 강의게시글 댓글
ALTER TABLE task_lec_board_reply
    ADD CONSTRAINT FK_task_lec_board_TO_task_lec_board_reply -- 강의게시판 -> 강의게시글 댓글
        FOREIGN KEY (
                     lec_board_no -- 강의게시글 번호
            )
            REFERENCES task_lec_board ( -- 강의게시판
                                       lec_board_no -- 강의게시글 번호
                );
