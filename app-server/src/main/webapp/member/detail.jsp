...
<c:set var="member" value="${memberDao.findBy(param.memberNo)}"/>
<!DOCTYPE html>
<html>
<head>
    <meta charset='UTF-8'>
...
<c:if test="${not empty member}">
    <form action='/member/update.jsp' method='post' enctype='multipart/form-data'>
        ...
        <div>
            ...
            <c:if test="${loginUser.memberNo == member.memberNo}">
                <button>변경</button>
                <a href='/member/delete.jsp?memberNo=${member.memberNo}'>삭제</a>
            </c:if>
