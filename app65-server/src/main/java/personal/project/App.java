...
public class App {
  ...
  public static void main(String[] args) throws Exception {
    ...
    StandardContext ctx = (StandardContext) tomcat.addWebapp(
            "/", // 컨텍스트 경로(웹 애플리케이션 경로)
            // App(현재 클래스) RunConfigration의 WorkingDirectory가 어떻게 되었는지 참고하여 아래의 경로를 잘 설정해줘야 한다.
    ...
    resources.addPreResources(new DirResourceSet(
            ...
            // App(현재 클래스)의 RunConfigration의 WorkingDirectory가 어떻게 되었는지 참고하여 아래의 경로를 잘 설정해줘야 한다.
